...
%% Last-Updated: 2020-06-11T14:58:02+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\documentclass[a4paper,10pt,final]{iopart}
...
\author{P.G.L.  Porta Mana$^1$}
\address{$^1$ Kavli Institute, Trondheim, Norway}
\ead{pgl@portamana.org}
\begin{abstract}
    This note illustrates how to perform dimensional analysis in
