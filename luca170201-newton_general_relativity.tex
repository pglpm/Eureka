\pdfoutput=1
%\pdfmapfile{+classico.map} %uncomment for arXiv
%% Author: PGL  Porta Mana
%% Created: 2015-05-01T20:53:34+0200
%% Last-Updated: 2018-03-09T18:54:34+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifafour
...
\begin{quote}
  \emph{Neither in Newtonian relativity or in general relativity should
    there be any distinction between inertial and non-inertial motion, or
    between forced and unforced motion.}
\end{quote}
% \par%\\[\jot]
% \noindent
...
This note is an exploration of some notions around kinematics, dynamics,
matter, inertia, and force in Newtonian- and general-relativistic continuum
mechanics. In part, I would like to understand in which possible ways the
...
\item Newtonian thermomechanics can be restated as a theory of
  ...
  among the forces \cites{noll1963}[\sect~I.13]{truesdell1977_r1991}. This
...
I believe that to appreciate the points above is also useful to compare the
particular and precise aims of Newtonian relativity with those, somewhat
vaguer, of general relativity. 

Being an exploration, so far I've been unable to present this note as a
linear logical development. So I plead with you to follow me in my ruffled
sequence of observations, questions, and possible answers.
...
and its points \emph{places} at time $t$. The choice of a slicing is, for
...
Our attention is directed to the dynamics of extended bodies endowed with
mass. In Newtonian continuum mechanics the notions of body and mass are
traditionally introduced separately
\cites[\sects~I.2--4]{truesdell1977_r1991}{noll1959,noll1973}. In
relativistic continuum mechanics mass is typically introduced intertwined
with the metric
\cites{grotetal1966,carteretal1972}[\chap~3]{rezzollaetal2013}.

It turns out  that mass and body can be introduced at a single stroke, as
two aspects of the same entity, and without a metric. The idea is analogous
to that of charge
...
closed two-dimensional surface in spacetime -- for example on a slice --
where $\yr \ne 0$, the matter 3-form selects a unique tube with
3-dimensional section containing that 2-surface. This represents our
ability to mark a small body of matter -- say, by drawing a
\enquote{$\mathord{\bigcirc}$} sign on an body, or throwing some leaves in
flowing water -- and then follow it as it moves and deforms in space as
time passes, with respect to some slicing and frame. A closed
outer-oriented 3-form is the perfect mathematical representation of this.

If we were to include a theory of mixtures
\citep[\eg][app.~5B]{truesdell1969_r1984}, we would represent different
substances by different matter 3-forms, which could also coexist in the
same spacetime region.


The matter 3-form $\yr$ of a body provides a frame $\yn$ wherever it
doesn't vanish. It is called a Lagrangean or \emph{material} frame
...
simply saying that each part of that body is at rest. In other words, it is
the frame in which that body is rigid. Note that $\yn$ is not the
4-velocity of matter; this is given instead by the condition
$\yn\cdot \di\ytn = 1$ in Newtonian relativity and
$\abs{\yn\cdot\yfg\cdot\yn} = 1$ in general relativity.
...
\begin{equation}
  ...
  \qquad
  \yd \defd \widebar{\yr} \equiv \yr + \yF\cdot\yr.
\end{equation}
...
or several metric volume elements \citep[\eg][\eqn~(7.205), \sect~7.3,
p.~361]{rezzollaetal2013} when matter flow is expressed by a 1-vector or a
1-form instead.


A matter 3-form cannot be used to define time lapse or distance, owing to
its purely differential-geometric nature. We could imagine to have a
collection of singular matter 3-forms with extensions in two dimensions
only, and decree them to be rigid. They would work as rigid rules to define
distances. But this is practically what a metric represents. For the moment
I'm leaving out electromagnetic phenomena, which would be capital in
defining the notions of straight line and distance.

\medskip

Question: would the notions and objects just introduced suffice for a
...
\section{Aims of Newtonian and general relativity}
\label{sec:aims}
...
\citey{bernoulli1703} \citep[see][p.~104]{truesdell1968}. Consider a small
