...
%% Last-Updated: 2020-06-15T20:43:07+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\puz}{\puzzle}% Sect.~
\newcommand*{\puzs}{\puzzle}% Sect.~
...
Several authors (\cf\ \puz~\ref{sec:metric-free}) seem to find this point
of view appealing.
...
studies may be unfamiliar to some readers and are summarized in \puzs***.
...
This reinterpretation is discussed in \puz***.
...
\section{The frame-invariant formulation of Newton's equations}
\label{sec:noll_inertia}

\mynote{Summary of \cites{noll1963}[\sect~I.13]{truesdell1977_r1991}}

\section{The metric-free representation of matter and charge}
...
to something of a different order? We'll see in \puz*** that there are
...
\mynote{to be written. See \puz~\ref{sec:constitutive equations}}
...
the questions of \puz~\ref{sec:soup}: are we to interpret forces as
...
\puz~\ref{sec:inertial_force} I explain how they are determined by the
...
of its source, see \puz~\ref{sec:inertial_force}, also requires a parallel
...
transverse to the slices, defined in \puz~\ref{sec:inertial_force}. Some
...
\puz~\ref{sec:newton_dynamics_absolute_time} has the advantage of being
...
\puz~\ref{sec:matter}) and entropy
...
case of \puz~\ref{sec:slicing_frames}.
...
\puz~\ref{sec:newtonian_continuum_thermomechanics} a summary of the aim of
...
I apologize for \puz~\ref{sec:newtonian_continuum_thermomechanics}, which
...
Then in \puz~\ref{sec:general_relativity} I give a summary of the
...
\puz~\ref{sec:inertial_force} I explain how the inertial field is
...
possibly just the 3-connection. I discuss this in \puz**; it is a form of
Mach's principle.
...
\item The metric tensor is nonchalantly spread everywhere in the
  ...
  saw in \puz~\ref{sec:matter}. Most literature instead
