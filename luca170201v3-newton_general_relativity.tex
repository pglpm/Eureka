...
%% Last-Updated: 2025-11-18T17:55:39+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\begin{abstract}\labelsep 0pt%
  {\itshape NB: The author has abandoned many of the points of view expressed in this research note. See more recent research notes\footnote{\url{https://github.com/pglpm/Eureka/raw/master/pglpm241222-notes_energy_momentum.pdf} and  \url{https://github.com/pglpm/Eureka/raw/master/pglpm231119-notes_electromagnetothermomechanics.pdf}.} for updated views.}

  This note is an exploration of some notions around kinematics,
...
\mynotew{to be written. See \sect~\ref{sec:constitutive equations}}
...
*** static formulation  \citep[\cf][part~III \sect~6 p.~652]{vandantzig1934b}
...
\mynotew{To be added: formulation with 2-point energy-momentum-stress tensor \citep[\sect~288]{truesdelletal1960}}
...
\mynotew{The idea in this section is probably seriously wrong}
...
\mynotew{To be added: refs to Finzi, Beltrami}

\mynotew{To be added: discussion about pp.~18--19 of \citep{weatherall2019}:
...
equations \mynotew{some $\pi$ factors may be missing!}
...
\mynotew{This section is a little disconnected from the rest. Must be better
integrated}
...
\mynotew{Refer to Weatherall \citey{weatherall2019}.}
...
\item The metric tensor is nonchalantly spread everywhere in the
  ...
  \citey{vandantzig1934,vandantzig1934b,vandantzig1936,vandantzig1937,schoutenetal1940,vandantzig1954}.
