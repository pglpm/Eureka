...
%% Last-Updated: 2020-06-14T23:41:33+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\enquote{We must warn the reader however, that it is unjustified to assume that the sequences
of deformations standing behind the limit processes used in the following purely kinematical
...
theory of bodies a sequence of deformations is produced by a sequence of loads, and whether
it is possible to choose the latter in such a way as to leave the local rotation fixed but vary
the extensions is dubious.} \sect~54 p.~303


***kinematic is necessary: no matter how we express the laws of actual
motion or state, eg as the extremization of a lagrangian, they
\emph{presuppose} a space of \emph{possibilities} from which the actual
motion is chosen. Kinematics defines that space of possibilities.
