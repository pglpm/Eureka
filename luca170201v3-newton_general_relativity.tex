...
%% Last-Updated: 2020-06-16T11:09:00+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\setsubsechook{\setsecnumformat{\upshape\csname the##1\endcsname\quad}}
...
\begin{subequations}
  ...
  \end{gather}
\end{subequations}
which are also part of the dynamical equations of general relativity.
...
See the brilliant discussion by \textcite{eckart1940c}.
...
The dynamical equation~\eqref{eq:div4stress} seems a four-dimensional
analogue of the fundamental equation of statics.

The concepts of Newtonian mechanics are thus strongly present in general
relativity. This presence carries several problems. The Newtonian stress is
eminently a vectorial object meant to be \emph{integrated}: its integral
over a surface enclosing a body yields the total surface force acting on
that body.

The integration of a vectorial object, however, is possible in Newtonian
mechanics thanks to the affine structure of its three-dimensional space.
This kind of integration is impossible or at best ambiguous with the
path-dependent parallel transport of general relativity. Some authors
relate this impossibility to the supposed absence of a
\enquote{conservation law} for 4-momentum
...
Even if we take the 4-stress $\yTf$ as a dynamical object common to the two
theories, some problems remain regarding its most appropriate geometric
nature.

In most texts the 4-stress is represented by a tensor of order 2. There are
indications that it could be more properly represented by a covector-valued
3-form, or by a 3-vector-valued 3-form (equivalent to a tensor
antisymmetric in the first three and last three slots), for reasons
connected with integration. See for example the discussion about
...
\section{Dynamics with absolute time}
...
case of \psect~\ref{sec:slicing_frames}.
...
Then in \psect~\ref{sec:general_relativity} I give a summary of the
