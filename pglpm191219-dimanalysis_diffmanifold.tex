...
%% Last-Updated: 2020-01-07T19:59:25+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
absolute dimension $\dim(\yg)$? The answer depends on the operational
meaning of the metric. Here is my favourite point of view, which follows
Synge and Bressan \citep[\sects~III.2--4]{synge1960b}[\sects~15,
18]{bressan1978}. Consider a (timelike) worldline $s \mapsto C(s)$,
$s\in \clcl{a,b}$, between events $C(a)$ and $C(b)$. The metric tells us
the \emph{proper time} elapsed for an observer having that worldline,
