...
%% Last-Updated: 2020-07-25T07:33:43+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\reporthead}{\iffalse\else Open Science Framework \href{https://doi.org/10.31219/osf.io/jmqnu}{\textsc{doi}:10.31219/osf.io/jmqnu}\fi}% Report number
...
\begin{acknowledgements}
  \ldots to (chronoligically) Mariano Cadoni, Ingemar Bengtsson, Iv\'an Davidovich, Claudia Battistin for
  ...
  No thanks go to arXiv, which rejected this paper, thus reducing the
  opportunity of preprint feedback; and which did not even give a reason
  for rejection, more like a private blog page than like a scientific service.
