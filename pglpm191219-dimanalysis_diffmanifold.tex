...
%% Last-Updated: 2020-10-24T18:51:37+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
element \citep[\sect~6.2]{abrahametal1983_r1988}. It can be seen as a
completely antisymmetric tensor of rank 4, with only one non-zero
component, given by the square root of the determinant of
...
define the \emph{natural metric volume element} $\ygv$ as follows:
\begin{equation}
...
version $\abs{\ygv}$ (sometimes called \emph{density}).
