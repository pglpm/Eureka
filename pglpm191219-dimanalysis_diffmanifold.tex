...
%% Last-Updated: 2020-10-25T09:56:36+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\yp}{p}
\newcommand*{\yt}{\sigma}
\DeclarePairedDelimiter\mul{\shortmid}{\shortmid}
...
I prefer to build the tensor architecture not on the tensor product of
vectors and covectors, but on that of multi-vectors and multi-covectors,
with their inner and outer orientations. This elegant, powerful, geometric
point of view leads to deeper physical insight, and is gaining popularity.
...
In the notation above, $k$-vectors and -covectors for $k>1$ are indicated
by bars. Thus $\yA\i{_{\q}^{\mul{\q\q}}}$ really means that $\yA$ is the
tensor product of a covector and a 2-vector.
...
define the \emph{standard metric volume element} $\ygv$ as follows:
\begin{equation}
