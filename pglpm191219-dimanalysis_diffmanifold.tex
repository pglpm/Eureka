...
%% Last-Updated: 2022-08-05T09:59:44+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\yC}{\dot{C}}
\newcommand*{\yU}{\bm{U}}
\newcommand*{\yUu}{\mkern2mu\underline{\mkern-2mu\yU\mkern-3mu}\mkern3mu}
...
that integration should happen over a volume instead: % We
...
momentum.% , energy, action, and seems to give the latter quantity a more
% fundamental status.
