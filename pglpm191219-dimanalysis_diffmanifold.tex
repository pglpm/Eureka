...
%% Last-Updated: 2020-01-01T23:22:08+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
reasoning relies on the modern, \emph{intrinsic} view of tensors \citep{choquetbruhatetal1977_r1996}
...
For dimensional analysis I use ISO conventions and notation. I sometimes use notation such as $\yT{}_{\bdot}{}^{\bdot}$ to indicate that the tensor $\yT$ is covariant in its first slot and contravariant in its second; I call this a "co-contra-variant tensor".
\citep{aldersley1977}
