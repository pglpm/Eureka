...
%% Last-Updated: 2020-01-11T20:16:02+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
%%% Epigraph
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \asudedication{\small Dedicated to Emma}
...
the dimension of constants in field and differential-geometric equations.
...
texts often use coordinates with dimension of length, and base their
dimensional analysis on that specific choice. They even multiply
coordinates with dimension of time, as well as some tensorial components,
by powers of $c$; thus giving the impression that coordinates ought to
...
the dimensional result of contraction, covariant derivative, raising an
index. This way of reasoning is presented and illustrated in
...
This way of reasoning relies on the coordinate-free, \emph{intrinsic} view
of tensors and other differential-geometrical objects, a brief reminder of
...
tensor remains the same. Formula~\eqref{eq:dim_component} for the
dimensions of the components is consistent under changes of coordinates.
For example, in new coordinates $({x'}^{k})$ with dimensions
$({\Xx'}_{k})$, the new components of $\yA$ are
\begin{equation}
...
Here is a summary of the dimensional results for the main
...
\sects~\ref{sec:connection}--\ref{sec:metric} below. I invite you to prove
them for yourself. For reference, in brackets I give the section of
Choquet-Bruhat \etal\ \citey{choquetbruhatetal1977_r1996} where the
...
\item The \emph{contraction} [III.B.5] of the $\alpha$th and $\beta$th
...
\item The \emph{transposition} of the $\alpha$th and $\beta$th slots of a
...
\end{equation}
and it's easily verified that the dimensions of these
coefficients~\eqref{eq:dim_christoffel} still holds. Also the result for
...
that doesn't depend on the dimensions of the coordinates. It would
therefore more profitable to focus on the absolute dimension of a tensor
rather than the dimensions of its components.
...
Finally, the above discussion specific to general relativity could of
course be made along the same lines also for Newtonian mechanics.
...
\begin{acknowledgements}
  \ldots to Mari, Miri, Emma for continuous encouragement and affection,
  and to Buster Keaton and Saitama for filling life with awe and
  inspiration. To the developers and maintainers of \LaTeX, Emacs, AUC\TeX,
  Open Science Framework, R, Python, Inkscape, Sci-Hub for making a free
  and impartial scientific exchange possible.
