...
%% Last-Updated: 2020-11-13T20:00:14+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
occurs, even in worse forms, in all other 15 alternatives for the
...
example in Einstein's original work \citep[\sect~C.9]{einstein1914b}, in
other early works
...
\citep[\chap~14 Exercise~14.18, \chap~15,
...
also][for similar conclusions in general manifolds and in classical
mechanics]{segevetal1999,kansoetal2007}.
...
which approach its operational definition from diverse points of view. This
is also the form obtained with variational principles from an action
Lagrangean
\citep[see
also][\sect~VII.8]{fokker1960_t1965}{gotayetal1998,gotayetal2004},
from which it's easily seen that it has the intrinsic dimension of an
action.
