...
%% Last-Updated: 2020-06-18T11:27:14+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\begin{abstract}\labelsep 0pt%
  ...
  dimension is independent of the dimensions of the coordinates. The
  ...
  meaning for the metric and stress-energy-momentum tensors is also
  discussed.
...
footnote~4]{truesdelletal1960}, \enquote{dimensional analysis remains a
  ...
  presentation here}.  References
about recent developments in this
  ...
  \begin{equation}
    ...
    \begin{gathered}
      (\tr_{\alpha\beta}\yA)(\dotso
        ...
        ,\dotso)
      \\
      \parbox{0.9\columnwidth}{for any arbitrary representation\; $\tsum_{i}
        \bm{u}_{i}\otimes\bm{\omega}^{i} \equiv \id$\; of\\ the identity
        operator (tensor)
      on the tangent space, \;$\id\colon
        \bm{v} \mapsto \bm{v}$ \;.}
    \end{gathered}
  \end{equation}
...
of temperature, and $y$ of specific entropy:
\begin{equation}
...
heat-conducting material \citep[for general-relativintic thermomechanics
see
\eg][]{eckart1940c,maugin1974b,maugin1978b,maugin1978c,maugin1978d,maugin1978e,muschiketal2014};
its temperature is uniform over the slices of a specific spacelike
foliation, but increases across the slices; its entropy density instead
increases along each 1-dimensional slice.
...
By the rules of dimensional analyses, the two sides of the expansion above
...
independent of the coordinate system, by construction -- that expansion
...
detail in \sect~\ref{sec:tensors}. The intrinsic dimension is determined by
the physical or operational meaning of the tensor. Together with the
dimensions of the coordinates it determines the dimensions of the
