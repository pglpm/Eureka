...
%% Last-Updated: 2020-10-30T17:00:00+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
to decimetres, the new coordinates $(x',y',z')$ are obtained from the old
multiplying by $10\,\textrm{dm}/\textrm{m}$, and the new energy density
$\en'$ is obtained from the old dividing by
$(10\,\textrm{dm}/\textrm{m})^{3}$. Only the second
...
stress-energy-momentum tensor should have the variance
\begin{multline}
  \label{eq:final_T}
\yT\i{_{\q\mul{\q\q\q}}} =
...
\end{multline}
the antisymmetric slots having a twisted orientation, and should have dimension
\begin{equation}
    \label{eq:final_dim_T}
  \dim\bigl(\yT\i{_{\q \mul{\q\q\q}}}\bigr) = \En\Ti \equiv \Ma\Le^{2}\Ti^{-1} \ ,
\end{equation}
that is dimension of an \emph{action}.
...
The result
 ...
 \citep[\sect~F.IV.288]{truesdelletal1960}
\citep[\chap~14 Exercise~14.18, \chap~15]{misneretal1970_r1973}
\citep[\cf][\sect~7]{brillouin1925}
\citep[esp.\ Theorem~1]{gotayetal1992}
 \citep{hehletal1986}
 \citep{gronwaldetal1997}
 \citep[\cf]{kansoetal2007}
\citep[\cf][\sect~13]{cartan1923}
