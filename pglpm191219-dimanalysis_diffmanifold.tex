...
%% Last-Updated: 2022-08-27T23:26:09+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\updated}{\ifarxiv 20 May 2021\else\today\fi}
...
Burke \cite*{burke1985_r1987}; Bossavit \cite*{bossavit1991}; and more on
...
Care must be taken with the covariant 4-velocity usually obtained by lowering the index of $\yU$. It is convenient to define it as
\begin{equation}
  ...
  \end{cases} \ .
\end{equation}
This definition leads to the same expression in rectangular Cartesian
...
$\dim(\yUu)^{-1} = \dim(\yU) = \Le^{-1}$ in this case.
