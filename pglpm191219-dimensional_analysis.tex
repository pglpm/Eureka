...
%% Last-Updated: 2020-06-12T09:57:07+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
have dimension of length. This is unnecessary.
...
Sections~\ref{sec:tensors}--\ref{sec:tensor_ops} give a more general and
...
\sect~\ref{sec:tensors}.


Dimensional analysis in differential geometry is crucially dependent This
way of reasoning relies on the coordinate-free, \emph{intrinsic} view of
tensors and other differential-geometrical objects, a brief reminder of
which is given in \sect~\ref{sec:remined}, with references.
