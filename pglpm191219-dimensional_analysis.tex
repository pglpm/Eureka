...
%% Last-Updated: 2020-06-12T18:06:59+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
of temperature, and $y$ of energy density:
\begin{equation}
...
\item The \emph{integral} [IV.B.1] of a form over a submanifold (or chain)
  $S$ has the same dimension as the form:
  \begin{equation}
    \dim\bigl(\tint_{S}\yom\bigr) =\dim(\yom).
...
and only if the \emph{intrinsic} dimension of $\yR$ is unity,
