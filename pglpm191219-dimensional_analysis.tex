...
%% Last-Updated: 2020-06-13T17:53:38+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\defquote{$A\i{_{\bm{i}}^{\bm{jk}}}$}. In our discussion, however, where
the difference between a tensor and its set of components will be crucial
the abstract-index notation lends itself to conceptual and typographic
misunderstanding.
...
of temperature, and $y$ of entropy density
\citep{eckart1940c,maugin1974b,maugin1978b}: 
\begin{equation}
