...
%% Last-Updated: 2020-10-18T15:37:16+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
obviously means $\yg(\ye_{k},\ye_{l})=\pm\delt_{kl}$). The volume element
...
The \emph{scalar curvature} $\ysc$ and the co-contra-variant \emph{Einstein
  tensor} $\yG\i{_{\q}^{\q}}$
\begin{equation}
  \label{eq:curv_einst}
  \ysc \defd \tr\yRi\i{_{\q}^{\q}}\equiv\tr(\yRi\ \yg^{-1})
  \ ,
  \qquad
...
\begin{equation}
  ...
  \end{cases}.
\end{equation}
Note that, from \eqn~\eqref{eq:raising_lowering}, \emph{the twice covariant
  Einstein tensor is dimensionless:} $\dim(\yG\i{_{\q\q}})=\Un$, just like
the Ricci and Riemann curvature tensors.
