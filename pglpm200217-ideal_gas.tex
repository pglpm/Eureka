...
%% Last-Updated: 2020-02-18T20:44:09+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\item $\yq$: heat flow
\end{itemize}
For an ideal gas, the fields $(n,\yv,\yte)$ constitute the state.
...
\begin{gather}
  ...
  \yq = -k(n,\yte)\,\nab\yte %- \kappa(n,\yte)\,\nab n
  \\
  \yT = -R n \yte\id + \lambda(n,\yte)\,\nab\cdot\yv \id + \mu(n,\yte)\,\nab\yv^{+}
  \\
  u = f(n,\yte)+\yte\de_{\yte}f % c \yte 
  \\
  k,\lambda,\mu\ge 0
\end{gather}
