...
%% Last-Updated: 2020-10-29T19:34:56+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
If $\gamma$ is an $N$-covector (hypervolume covector), so that
...
\end{gather}
for any vector $u$ and form $\omega$. According
to~\eqref{eq:right_inner_prod},
\begin{equation}
