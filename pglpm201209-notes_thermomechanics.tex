...
%% Last-Updated: 2020-12-09T20:07:06+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\firstdraft}{9 December 2020}
\newcommand*{\firstpublished}{\firstdraft}
\newcommand*{\updated}{\ifarxiv***\else\today\fi}
\newcommand*{\propertitle}{Notes on thermomechanics, thermodynamics,
  statistical mechanics%\\{\large ***}%
}% title uses LARGE; set Large for smaller
\newcommand*{\pdftitle}{\propertitle}
\newcommand*{\headtitle}{Thermomechanics and statistical mechanics}
...
\begin{abstract}\labelsep 0pt%
  \noindent Some notes on understanding thermomechanics, thermodynamics,
...
\section{The second law in thermomechanics and thermostatics}
\label{sec:2nd_law_TM_TS}
