...
%% Last-Updated: 2022-07-22T11:45:53+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\begin{equation}
  ...
  \di\bm{Q} = 0 \ ,
\end{equation}
which leads to, considering the permutations and antisymmetry,
\begin{multline}
  \label{eq:charge_cons_calculated}
\di\bm{Q} = \de_{t}\rho\ \ti txyz 
  -\de_{x}j_{x}\ \ti xtyz
  -\de_{y}j_{y}\ \ti ytzx
  -\de_{x}j_{x}\ \ti ztxy
  ={}\\
  ...
  \ti txyz = 0 \ ,
\end{multline}
leading to the familiar \autocites[\eqn~(1.14)]{kovetz2000}
\begin{equation}
  \label{eq:familiar_charge_cons}
  \de_{t}\rho + \de_{x}j_{x} + \de_{y}j_{y} + \de_{z}j_{z} = 0 \ ,
\end{equation}
bu now shown to be \emph{valid in any coordinate system}.
