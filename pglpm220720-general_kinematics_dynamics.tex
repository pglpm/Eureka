...
%% Last-Updated: 2022-07-22T09:46:59+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\tw}[1]{\underline{#1}}
%\newcommand*{\un}[2]{\underbracket[0pt][0pt]{#1}_{\scriptscriptstyle #2}}
%\newcommand*{\ti}{\tw{\di}}
%\newcommand*{\te}{\tw{\de}}
\newcommand*{\un}[2]{\underset{\mathclap{{}^{#2}}}{#1}}
\newcommand*{\ti}{\un{\di}{\scriptstyle\sim}}
\newcommand*{\te}{\un{\de}{\scriptstyle\sim}}
\newcommand*{\tti}[1]{\un{\di}{#1}}
\newcommand*{\tte}[1]{\un{\de}{#1}}
...
\\
  \shortintertext{On it, the basis twisted 1-forms map to}
  \begin{gathered}
  \tti{-xyz} t\bigr\rvert_{V} = 0\ , \quad
  \tti{tyz} x\bigr\rvert_{V} = \tti{vw} u\ , \quad
  \tti{tzx} y\bigr\rvert_{V} = \tti{wu} v\ , \quad
  \tti{txy} z\bigr\rvert_{V} = \tti{uv} w\ ,
  \\
  \tti{t}xyz\bigr\rvert_{V} = \tti{+}uvw \ .
\end{gathered}
\end{gather}
Then we have
\begin{equation}
