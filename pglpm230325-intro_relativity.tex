...
%% Last-Updated: 2023-03-27T21:20:36+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
In both Newtonian and Lorentzian relativity we can introduce a matter 3-covector field $\yn$. Given a small spacelike 3-volume, any observer can trace a world-tube in spacetime out of it. For a very small 3-volume, the worldtube is a worldline.

Given a metric $\yg$ and corresponding volume 4-vector $\ygv$, we can associate to the matter 3-covector $\yn$ a 4-velocity $\yv$ by \autocites[\cf][p.~920]{eckart1940c}
\begin{equation}
  \label{eq:matter_to_4velocity}
  \yv \defd \frac{c\,\yn\cdot\ygv}{\sqrt{\abs{\yn\cdot\ygv\,\yg\,(\yn\cdot\ygv)}\,}}
  \ .
\end{equation}
