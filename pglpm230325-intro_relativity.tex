...
%% Last-Updated: 2023-03-26T17:54:29+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\mynotep{Next: introduce radar coordinates. Emphasis on the fact that they can only be local. Notion of \enquote{constant distance or position} with respect to an observer. \emph{Definition} of local velocity.}
...
\begin{equation}
  ...
  \int_{s_{0}}^{s_{1}}\frac{1}{c}\sqrt{\abs{\dot{C}(s)\,\yg[C(s)]\,\dot{C}(s)}\,}\,\di s \ .
\end{equation}
...
\begin{equation}
  ...
  \biggl(1-\frac{\yV^{2}}{c^{2}}\biggr)^{-\frac12}\,
  (1, \yV) \ .
\end{equation}

These formulae also reveal the usual \enquote{time dilation} and \enquote{length contraction} phenomena. A time lapse of $\epsilon$ for the observer with 4-velocity $\yu$ has a larger \emph{radar-time lapse} of $\epsilon\yvu\yu = \epsilon/(1-\yV^{2}/c^{2})$ according to $\yv$, since $1-\yV^{2}/c^{2} \le 1$. That is,
