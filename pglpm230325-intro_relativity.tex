...
%% Last-Updated: 2023-04-08T13:32:57+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\firstdraft}{\textbf{Draft.} 25 March 2023}
...
\begin{acknowledgements}
  ...
  Framework, R, %Python,
  Inkscape, LibreOffice, Sci-Hub for making a free and impartial
...
\section{Geometric remarks and conventions}
\label{sec:geom_remarks}

I summarize here some remarks and convenient conventions of a geometric character.

\subsection{Coordinates and orderings}
\label{sec:coords_order}

Coordinates in a region are typically denoted $t,x,y,z$, corresponding to indices $0,1,2,3$. Coordinate $t$ has dimensions of time, $x,y,z$ of length. With these coordinates we associate an inner orientation in the given order.

To work with multivector and multicovector spaces and with orientations, It is useful to set up the following correspondence between various \emph{ordered} groupings of coordinates (the symbol \enquote{$\corr$} means \enquote{corresponds to}):
\begin{equation}
  \label{eq:corresp}
  \begin{gathered}
    1 \corr txyz\\
  ...
  \end{gathered}
\end{equation}
the correspondence being symmetric.
