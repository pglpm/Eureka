...
%% Last-Updated: 2023-11-08T15:27:02+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\propertitle}{\enquote{Affine} ideal gas%
}% title uses LARGE; set Large for smaller
\newcommand*{\pdftitle}{\propertitle}
\newcommand*{\headtitle}{\enquote{Affine} ideal gas}
\newcommand*{\pdfauthor}{P.G.L.  Porta Mana}
\newcommand*{\headauthor}{Porta Mana}
\newcommand*{\reporthead}{\iffalse\else Open Science Framework \href{https://doi.org/10.31219/osf.io/***}{\textsc{doi}:10.31219/osf.io/***}\fi}% Report number
...
limitations: \mynotez{Make the following statements more precise; concrete
  examples}
\begin{enumerate}
...
temperature, and negligible mass. \mynotez{Make more precise.}
...
or equivalently heating flux $Q$ at the boundary \mynotez{I must check
...
The quantities above must still satisfy the energy-balance equation, which reduces to

\begin{multline}
  \label{eq:balance_en_final}
  8 A^{2} R \yVb \yVd\,(3NR\ytb - 2\yE\yVd) +{}\\
  3\yVb^{2}\,(8A^{2}\yC N R \dot{\ytb} + 8 A^{2} M K\yVdd + M N (\yC+R)\yVd\yVdd)
  +
  3\yC M N \yVb^{3}\dddot{\yVb} +{}\\
  -12 A^{2} M Nx^{2}\,
  ((\yC+R)\yVd\yVdd + C\yVb\dddot{\yVb}) = 0
\end{multline}
...
\mynotez{this can be a computation error on my part. All these calculations
