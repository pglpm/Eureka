...
%% Last-Updated: 2026-05-06T22:16:39+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\begin{equation}
  ...
  \end{split}
\end{equation}
Where $\yE$ is a 1-covector and $\yB$ a 2-covector. Given a system of
coordinates, this decomposition is unique. Neither the 2-covector $\yB$ or
the 1-covector $\yE$ have any $\si{t}$ components, that is, they have the vector
$\se{t}$ in their kernels.
