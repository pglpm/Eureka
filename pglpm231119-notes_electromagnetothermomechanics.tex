...
%% Last-Updated: 2025-11-23T09:13:14+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
the 1-covector $\yE$ have any have $\si{t}$ components, that is, they don't have
...
{}
  ...
  -(\yUd\,\yS)\cdot\nabla\yU \ .
\end{gather}
The last balance equation corresponds to \eqn~(28) in \textcites{eckart1940c}, except for the fact that here we are keeping the momentum $\yP$ and heat flux $\yH$ distinct.
