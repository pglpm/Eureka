...
%% Last-Updated: 2026-05-06T16:28:40+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
If the line element has length $l^{z}$, expressed in units of the coordinate $z$, then it is given by
\begin{equation*}
  l^{z}\, \se{z} \ .
\end{equation*}
...
\item $J^{i}$ is the areic flux of amount of matter (equivalent to a molar flux) through a small area at rest in the coordinate system $(t, x^{i})$, measured per unit coordinate area and unit coordinate time.
\end{itemize}
...
\begin{itemize}
\item $Q$ is the volumic charge, measured per unit coordinate volume.
\item $I^{i}$ is the areic flux of charge through a small area at rest in the coordinate system $(t, x^{i})$, measured per unit coordinate area and unit coordinate time.
\end{itemize}
