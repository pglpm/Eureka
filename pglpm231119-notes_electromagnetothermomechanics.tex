...
%% Last-Updated: 2026-05-22T08:24:04+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\begin{equation}
  ...
  \end{split}
\end{equation}
Where $\yE$ is a 1-covector and $\yB$ a 2-covector. Given a system of coordinates $(t,x,y,z)$, this decomposition is unique. Neither the 2-covector $\yB$ or the 1-covector $\yE$ have any $\si{t}$ components, that is, they have the vector $\se{t}$ in their kernels.
...
\begin{gather}
  ...
  \begin{aligned}
    ...
    \\[\jot]
    &\de_{t}B^{i} + \epsilon^{ijk}\de_{j}E_{k} = 0
    &&\qquad\text{($\sssi{tx^{j}x^{k}}$ components)}
    % \\
