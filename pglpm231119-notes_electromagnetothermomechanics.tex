...
%% Last-Updated: 2026-05-22T22:33:17+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
The four-velocity is defined by the following properties and identity:
\begin{gather}
  \label{eq:prop_UN}
...
\section{Charge and magnetic flux}
\label{sec:charge_magnet}
...
\begin{gather}
  \label{eq:aether}
  \yG = \frac{1}{\mu_{0}} \, \ve :
  \bigl( \yg^{-1} \cdot \yF \cdot \yg^{-1} \bigr)
  \\
