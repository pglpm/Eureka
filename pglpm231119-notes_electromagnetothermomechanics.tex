...
%% Last-Updated: 2024-11-02T17:51:03+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\end{equation}
which is a conservation law if $\yV$ is a Killing vector. We only need to require this for four independent vector fields, which we can choose to be $\set{\se{\alpha}}$. For the special case $\yV=\se{\alpha}$ the formula above becomes, thanks to equations~\eqref{eq:d_3cov} and~\eqref{eq:d_3ext1cov},
\begin{equation}
...
Given a coordinate system $(t, x^{i})$, we can use formula \eqref{eq:balance_VT_current} with a special set of ten vector fields, obtaining a set of ten balance laws \autocites[\sect~3.2]{hawkingetal1973_r1994}. The vector fields are, separated into four groups of one, three, three, and three,
\begin{gather}
  \label{eq:kil_energy}
  \se{t}
