...
%% Last-Updated: 2026-05-06T14:15:17+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\end{equation}
which represents a motion with coordinate velocity $v^{i}$ for a time lapse $\tau$. The resulting timelike volume is
\begin{equation}
...
\begin{equation}
  ...
  + \tau\,v^{x}\se{x} + \tau\,v^{y}\se{y} + \tau\,v^{z}\se{z}
\end{equation}
The resulting timelike surface is
\begin{equation}
