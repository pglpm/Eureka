...
%% Last-Updated: 2024-12-02T10:58:32+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
On the other hand, it is the vector $\se{t}/\nor{\se{t}}$ which corresponds to the traditional total, \enquote{internal plus kinetic} energy in the Newtonian limit, where the \enquote{kinetic} part only involves the velocity of the matter element in the particular coordinates used.
