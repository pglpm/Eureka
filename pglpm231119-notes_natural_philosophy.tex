...
%% Last-Updated: 2023-11-24T13:18:54+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\begin{equation}
  ...
  \ve \defd \frac{1}{c}\dg\ \ssssi{\tw{t}xyz} \equiv \frac{1}{c}\dg\ \tttti{}
\end{equation}
...
\right\}\quad
\begin{gathered}
  \xrightarrow{\quad\mathclap{\vi\cdot{}}\quad}
  \\
  \xleftarrow{\quad\mathclap{{}\cdot\ve}\quad}
\end{gathered}
\quad\tfrac{c}{\dg}\left\{
\begin{gathered}
  \ssse{xyz}\enspace
...
\begin{multline}
  ...
  -\frac{1}{c\,g_{tt}\dg}\,\epsilon\, \se{t}\otimes\se{t}
  -\frac{1}{c\,g_{tt}\dg}\,q^{i}\, \se{i}\otimes\se{t} +{}\\
  \sum_{j}\frac{c}{g_{jj}\dg}\,p_{j}\, \se{t}\otimes\se{j} +
  \sum_{j}\frac{c}{g_{jj}\dg}\,\pi^{i}_{j}\, \se{i}\otimes\se{j}
\end{multline}
...
\begin{equation}
  ...
  \end{aligned}
\end{equation}
This corresponds to the four balance equations
\begin{align}
  \label{eq:div_e}
  \de_{t}e + \de_{i}q^{i} &=
  e\,\varGamma^{t}_{tt}
...
\section{References for useful mathematical identities}
\label{sec:ref_maths}
