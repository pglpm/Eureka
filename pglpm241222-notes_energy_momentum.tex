...
%% Last-Updated: 2024-12-27T12:43:45+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\begin{equation}
  \label{eq:angmomentum_current}
   ...
   x\,\yPP_{y} - y\,\yPP_{x} \ .
\end{equation}
The currents associated with the last three reference fields are the analogous components of boost momentum; they depend on the specific choice of reference field for energy. In some important situations the reference fields~\eqref{eq:ref_angmomentum} are Killing  fields, and therefore the associated currents~\eqref{eq:angmomentum_current} satisfy conservation laws.
