...
%% Last-Updated: 2024-12-26T16:53:51+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\begin{equation}
  \label{eq:angmomentum_current}
   ...
   x\,\yPP_{y} - y\,\yPP_{x} \ .
\end{equation}
The currents associated with the last three reference fields are the analogous components of boost momentum; they depend on the specific choice of reference field for energy.
