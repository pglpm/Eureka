...
%% Last-Updated: 2024-12-25T22:56:49+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\item The energy four-current
  ...
  \end{equation}
  associated with the matter four-velocity $\yUm$ is what we call \emph{internal energy-mass}. Note that this reference field is unrelated to the coordinates. This is why internal energy is an invariant in the Newtonian approximation and even in the exact case.
