...
%% Last-Updated: 2025-01-05T12:25:25+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
Choose an arbitrary non-zero vector field $\yV = V^{\nu}\ve{\nu}$ over a four-dimensional spacetime region. We call it a \emph{reference vector field}. Keep in mind that this reference field doesn't need to be related in any way with the system of coordinates under use.
