...
%% Last-Updated: 2024-12-25T23:24:21+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
In the expressions above, $\vi{x^{\mu}}$ are the differentials of the coordinates $x^{mu}$ and form a basis for covector fields, and $\ve{\mu}$ are the dual vectors and form a basis for vector fields. The $\ttti{\mu}$ are volume forms defined as follows:\autocites[notation similar to][\sect~2 p.~371]{gotayetal1992}
\begin{equation}
