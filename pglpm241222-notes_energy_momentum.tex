...
%% Last-Updated: 2024-12-28T14:26:04+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
Answer: Momentum is not a vector in itself, but a set of components of a more complex geometric objects. Their transformation therefore depends on the values of the other components of that object.
\end{enumerate}
